<div align="center">
  <h1>
    <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="50" height="50" alt="wave">
    <br>
    Welcome to my GitHub! I'm <span style="color:#00DC82; font-size:28px;"><b>Nguyễn Quốc Bảo</b></span>
  </h1>
  ...
  <p align="center">
    ...
    &nbsp;&nbsp;
    <a href="https://github.com/quocbaong?tab=followers">
      <img src="https://img.shields.io/github/followers/quocbaong?label=Followers&style=flat-square&color=00DC82&logo=github" alt="GitHub Followers">
    </a>
    &nbsp;&nbsp;
...
<img align="right" src="https://media.giphy.com/media/SWoSkN6DxTszqKSaUv/giphy.gif" alt="Coder" width="280" style="border-radius: 10px;">
...
- 🚀 Currently learning **Spring Boot**, **React**, and **Docker**
- 💻 Skilled in **Java**, **JavaScript/TypeScript**, **C++**, and more
- 🔗 Interested in **API design**, **database architecture**, and **clean code**
- 🌟 Love **open-source** contributions and **team collaboration**
  ...
  <table>
    <tr>
      <td align="center" width="25%">
        <h3>🥇 Projects</h3>
        <p>Completed <strong>10+</strong> web & software projects</p>
      </td>
      <td align="center" width="25%">
        <h3>🎯 Skills</h3>
        <p>Proficient in <strong>Full Stack</strong> development</p>
      </td>
      <td align="center" width="25%">
        <h3>🌟 Open Source</h3>
        <p>Active in <strong>collaboration</strong> & contributions</p>
      </td>
      <td align="center" width="25%">
        <h3>💡 Problem Solving</h3>
        <p>Love <strong>debugging</strong> & optimization</p>
      </td>
    </tr>
  </table>
</div>
...
## 🎯 My Goals & Learning Roadmap

<div align="center">
  <table>
    <tr>
      <td><strong>2024-2025</strong></td>
      <td>Master <strong>Spring Boot</strong> & <strong>React</strong></td>
    </tr>
    <tr>
      <td><strong>2025-2026</strong></td>
      <td>Learn <strong>Docker</strong>, <strong>Kubernetes</strong> & microservices</td>
    </tr>
    <tr>
      <td><strong>2026+</strong></td>
      <td>Become a <strong>Senior Full Stack Developer</strong></td>
    </tr>
  </table>
</div>
